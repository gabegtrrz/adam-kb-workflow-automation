...
def main():
    ...
    output_folder_path = input_folder_path / timestamp_str
    ...
    with Pool(processes=num_workers) as pool:
        starmap_iterator = pool.starmap(func=ocr_worker,iterable= tasks_for_starmap)

        progress_iterator = tqdm(starmap_iterator, desc="Processing PDFs", total=len(tasks_for_starmap))
